...
if __name__ == "__main__":
    ...
    controls = []
    win32gui.EnumChildWindows(handle, callback, controls)
    ...
    # left_down(controls[1], 300, 105)
    # time.sleep(1)
    # left_up(controls[1], 300, 105)
    # time.sleep(1)

    win32api.SendMessage(controls[0], win32con.WM_LBUTTONDOWN, win32con.MK_LBUTTON, win32api.MAKELONG(199, 431))
    time.sleep(0.1)
    win32api.SendMessage(controls[0], win32con.WM_LBUTTONUP, win32con.MKF_LEFTBUTTONDOWN, win32api.MAKELONG(199, 431))
    # 控制角色向前移动两秒
